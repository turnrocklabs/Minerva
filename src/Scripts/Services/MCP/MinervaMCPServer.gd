...
func _execute_tool_impl(tool_name: String, arguments: Dictionary) -> Dictionary:
	...
	match tool_name:
		...
		"minerva_container_add":
			return _container_add(arguments)
		...
		"minerva_terminal_list":
			return _terminal_list(arguments)
		"minerva_terminal_write":
			return _terminal_write(arguments)
...
func _register_container_tools() -> void:
	...
	_register_tool("minerva_container_add",
	...
	_register_tool("minerva_container_remove",
...
func _register_terminal_tools() -> void:
	_register_tool("minerva_terminal_list",
