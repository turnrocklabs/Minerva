...
var is_square: = false
var is_crayon: = false
var CloudType: CloudControl.Type = CloudControl.Type.ELLIPSE
...
func _on_option_button_item_selected(index):
	...
	match index:
		0:
			CloudType = CloudControl.Type.ELLIPSE
		1:
			CloudType = CloudControl.Type.SPEECH_BUBBLE
		2:
			CloudType = CloudControl.Type.RECTANGLE
