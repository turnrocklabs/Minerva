...
and distributed under the Boost Software License 1.0. Packaged helpers retain
the license, dependency lock, and exact source provenance beside the executable.
