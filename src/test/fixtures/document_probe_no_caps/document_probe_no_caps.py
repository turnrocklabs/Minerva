#!/usr/bin/env python3
"""Negative-control fixture: requests host.documents.list_open without
declaring it in permissions.host_capabilities. The broker MUST deny.

Used to exercise the deny path + audit log entry for host.documents.*.
"""
...
TOOLS = [
    {
        "name": "probe_list_denied",
        "description": "Attempts host.documents.list_open without permission.",
    ...
    while True:
        ...
        if method == "initialize":
            send({"jsonrpc": "2.0", "id": req_id, "result": {
                ...
                "capabilities": {"tools": {}},
                "serverInfo": {"name": "document_probe_no_caps", "version": "0.1.0"},
            }})
