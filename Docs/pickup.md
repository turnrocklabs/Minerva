...
LATEST 2026-06-11 (session 12 — **B5 HITL SESSION 3: distill + note/speak delivery + PLUGIN_EVENT→chat-wake ALL PASSED LIVE; 4 plugin fixes + 1 core fix; NEXT = codex profile calibration**). **HEAD-OF-LINE.**
